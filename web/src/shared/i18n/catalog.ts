...
export const catalog = {
  ...
  'key.lr': {
    message: 'L R',
    description:
      'Key caps for applying a classification label, exactly as docs/09 §6 writes them. The document does not say whether that is a chord or two keys, and R is already bound to Rename one row above it; ENC-896 carries the contradiction.',
  },
  'key.delete': {
    message: 'Del',
    description:
